    ...
    resources: {
      ru: {
        translation: {
          ...
          // Новые переводы для обработки ошибок
          "genericError": "Произошла непредвиденная ошибка. Попробуйте еще раз.",
          "gpsPermissionDenied": "Доступ к геолокации запрещен. Разрешите доступ в настройках браузера.",
          "gpsPositionUnavailable": "Местоположение недоступно. Убедитесь, что GPS включен.",
          "gpsTimeout": "Превышено время ожидания GPS. Попробуйте еще раз.",
          "gpsGenericError": "Ошибка GPS. Проверьте настройки и подключение.",
          "networkError": "Ошибка сети. Проверьте подключение к интернету.",
          "validationError": "Данные не прошли валидацию. Проверьте введенные значения.",
